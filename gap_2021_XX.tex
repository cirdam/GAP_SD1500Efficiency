...
\begin{figure}[H]
    \center
    \makebox[\textwidth][c]{\includegraphics[height=0.9\textheight]{plots/EfficiencyZenith.pdf}}
...
\begin{figure}[p]
    \begin{center}
       \makebox[\textwidth][c]{ \includegraphics[height=0.9\textheight]{plots/EfficiencyZenithNew.pdf}}
